    ...
    public partial class Service
    {
        ...
        public bool CancerInquiry(DO_IDENTIFIER PersonID)
        {
            ...
            try
            {
                ...
                string KP = "";
                Srv.HeaderMessageVOValue = _CreateHeader();
                KP = _ExtractKeyPair(Srv.HeaderMessageVOValue);
                // ------------------------part1------------------------------------------
                // ------------------------part2------------------------------------------
        ...
        public ResultVO SaveMedicationPrescription(MedicationPrescriptionsMessageVO MedicationPrescriptionsMessage)
        {
            try
            {
                ...
                srv.Url = GetUrlSepasNode() + "/MedicationPrescriptionService.asmx";

                // Dim v As New Variable
                srv.HeaderMessageVOValue = new HeaderMessageVO();
                srv.HeaderMessageVOValue.Sender = new SystemSenderVO();
                srv.HeaderMessageVOValue.Sender.SystemID = v.GetSystemID;
                srv.HeaderMessageVOValue.Sender.LocationID = Location.ID;
                srv.HeaderMessageVOValue.Sender.URL = "0";
                // -------------------------(Begin-PrimaryDefinition)------------------------'
                DO_IDENTIFIER SystemID, LocationID;
                SystemID = new DO_IDENTIFIER() { Assigner = "MOHME_IT", ID = srv.HeaderMessageVOValue.Sender.SystemID, Issuer = "MOHME_IT", Type = "System_ID" };
                LocationID = new DO_IDENTIFIER() { Assigner = "MOHME_IT", ID = srv.HeaderMessageVOValue.Sender.LocationID, Issuer = "MOHME_IT", Type = "Org_ID" };
                ...
                result = srv.SaveMedicationPrescriptionSecure(b);
                return result;
            }
            catch (Exception ex)
            {
        ...
        public MedicationPrescriptionsMessageVO GetPrescriptionMessageByHID(DO_IDENTIFIER HID)
        {
            try
            {
                ...
                CESrv.HeaderMessageVOValue = new HeaderMessageVO();
                CESrv.HeaderMessageVOValue.Sender = new SystemSenderVO();
                CESrv.HeaderMessageVOValue.Sender.SystemID = v.GetSystemID;
                CESrv.HeaderMessageVOValue.Sender.LocationID = Location.ID;
                v.ManageTokeninHeader(CESrv.HeaderMessageVOValue);
                string KP = _ExtractKeyPair(CESrv.HeaderMessageVOValue);
                // -------------------------------------Generate HeaderMessage --------------------------------
        ...
        public ResultVO SaveDispensedPrescription(DispensedPrescriptionsMessageVO DispensedPrescriptionsMessage)
        {
            try
            {
                DO_IDENTIFIER Location = GetHealthCareFacility();
                ClientWebService.SepasGate.MergAdaptorService srv = new ClientWebService.SepasGate.MergAdaptorService();
                srv.Url = GetUrlSepasNode() + "/DispensedPrescriptionService.asmx";
                ...
                result = srv.SaveDispensedPrescriptionSecure(b);
                return result;
            }
            catch (Exception ex)
            {
        ...
        public ResultVO ReferPatientRecord(ReferralCaseMessageVO ReferralCaseMessage)
        {
            try
            {
                ...
                ClientWebService.SepasGate.MergAdaptorService srv = new ClientWebService.SepasGate.MergAdaptorService();
                srv.Url = GetUrlSepasNode() + "/ReferralCaseService.asmx";
                ...
                System.Data Encrypt_SymmetricKeyStr = new System.Data();
                System.Data k = new System.Data(), iv = new System.Data();
                ...
                srv.HeaderMessageVOValue.Sender.IP = IPHost.AddressList[0].ToString(); // InternalIP
                // -------------------------------------Generate HeaderMessage IP Temp --------------------------------

                if (System.Net.Configuration.Security_Mode == System.Net.Configuration.SecurityMode.PowerSecurity)
                    srv.HeaderMessageVOValue.Sender.URL = "http://ca.mohme.gov.ir/1/" + Encrypt_SymmetricKeyStr.ToBase64;
                // -------------------------------------Generate HeaderMessage --------------------------------
                ...
                return srv.SaveReferralCaseSecure(b);
            }
            // -------------------------------------Send Message to SEPAS if needed--------------------------------
        ...
        public ReferralFeedbackMessageVO GetFeedbackPatienRecord(DO_IDENTIFIER HID)
        {
            try
            {
                ...
                // -------------------------------------Generate HeaderMessage IP Temp --------------------------------
                IPHostEntry IPHost = Dns.GetHostByName(Dns.GetHostName());
                CESrv.HeaderMessageVOValue.Sender.IP = IPHost.AddressList[0].ToString(); // InternalIP
                // -------------------------------------Generate HeaderMessage IP Temp --------------------------------
        ...
        public ResultVO SendFeedbackPatientRecord(ReferralFeedbackMessageVO ReferralFeedbackMessage)
        {
            try
            {
                ...
                ClientWebService.SepasGate.MergAdaptorService srv = new ClientWebService.SepasGate.MergAdaptorService();
                srv.Url = GetUrlSepasNode() + "/ReferralFeedbackService.asmx";
                ...
                System.Data Encrypt_SymmetricKeyStr = new System.Data();
                AdditionalTools.Encryption.Data k = new AdditionalTools.Encryption.Data(), iv = new AdditionalTools.Encryption.Data();
                ...
                // -------------------------------------Send Message to SEPAS if needed--------------------------------
                return srv.SaveReferralFeedbackSecure(b);
            }
            // -------------------------------------Send Message to SEPAS if needed--------------------------------
            catch (Exception ex)
            {
        ...
        public ResultVO SaveLaboratoryPrescriptions(LaboratoryPrescriptionsMessageVO LaboratoryPrescriptionsMessage)
        {
            try
            {
                ...
                ClientWebService.SepasGate.MergAdaptorService srv = new ClientWebService.SepasGate.MergAdaptorService();
                srv.Url = GetUrlSepasNode() + "/LaboratoryPrescriptionService.asmx";
                ...
                // -------------------------------------Send Message to SEPAS if needed--------------------------------
                return srv.SaveLaboratoryPrescriptionSecure(b);
            }
            // -------------------------------------Send Message to SEPAS if needed--------------------------------
        ...
        public ResultVO SaveLaboratoryResult(LaboratoryResultMessageVO LaboratoryResultMessage)
        {
            try
            {
                DO_IDENTIFIER Location = GetHealthCareFacility();
                ClientWebService.SepasGate.MergAdaptorService srv = new ClientWebService.SepasGate.MergAdaptorService();
                srv.Url = GetUrlSepasNode() + "/LaboratoryResultService.asmx";
                ...
                result = srv.SaveLaboratoryResultSecure(b);
                return result;
            }
            catch (Exception ex)
            {
        ...
        public ResultVO SavePathologyReport(LaboratoryResultMessageVO PathologyReport)
        {
            try
            {
                DO_IDENTIFIER Location = GetHealthCareFacility();
                ClientWebService.SepasGate.MergAdaptorService srv = new ClientWebService.SepasGate.MergAdaptorService();
                srv.Url = GetUrlSepasNode() + "/PathologyCaseReportService.asmx";
                ...
                result = srv.SavePathologyReportSecure(b);
                return result;
            }
            catch (Exception ex)
            {
        ...
        public ResultVO SaveMedicalImagingPrescriptions(ImagingPrescriptionsMessageVO ImagingPrescriptionsMessage)
        {
            try
            {
                ...
                ClientWebService.SepasGate.MergAdaptorService srv = new ClientWebService.SepasGate.MergAdaptorService();
                srv.Url = GetUrlSepasNode() + "/MedicalImagePrescriptionService.asmx";
                ...
                // -------------------------------------Send Message to SEPAS if needed--------------------------------
                return srv.SaveMedicalImagePrescriptionSecure(b);
            }
            // -------------------------------------Send Message to SEPAS if needed--------------------------------
        ...
        public ResultVO SaveDentalCase(DentalCareMessageVO DentalCareMessage)
        {
            try
            {
                DO_IDENTIFIER Location = GetHealthCareFacility();
                ClientWebService.SepasGate.MergAdaptorService srv = new ClientWebService.SepasGate.MergAdaptorService();
                srv.Url = GetUrlSepasNode() + "/DentalCaseService.asmx";
                ...
                result = srv.SaveDentalCaseSecure(b);
                return result;
            }
            catch (Exception ex)
            {
        ...
        public ResultVO SaveDeathCertificate(DeathCertificateMessageVO DeathCertificateMessage)
        {
            try
            {
                DO_IDENTIFIER Location = GetHealthCareFacility();
                ClientWebService.SepasGate.MergAdaptorService srv = new ClientWebService.SepasGate.MergAdaptorService();
                srv.Url = GetUrlSepasNode() + "/DeathCertificateService.asmx";
                ...
                result = srv.SaveDeathCertificateSecure(b);
                return result;
            }
            catch (Exception ex)
            {
        ...
        ///         ''' <returns>The method returns an object of type ResultVO. ResultVO models the response of SEPAS nodes either successful or unsuccessful.</returns>
        public DataModel.ResultVO SaveSIYABReport(SOAPMessageVO SOAPReport)
        {
            ...
            try
            {
                WCF_SIYABService.DO_IDENTIFIER Location = GetHealthCareFacility();
                ...
                var response = srv.SaveSIYABReportSecureAsync(secureRequest);
                result = ClientModelMapper.ToClientResponse<ResultVO, WCF_SIYABService.SaveSIYABReportSecureResponse>(response.Result);
                return result;
            }
            catch (Exception ex)
            {
        ...
        public ResultVO SaveSOAPReport(SOAPMessageVO SOAPReport)
        {
            try
            {
                DO_IDENTIFIER Location = GetHealthCareFacility();
                ClientWebService.SepasGate.MergAdaptorService srv = new ClientWebService.SepasGate.MergAdaptorService();
                srv.Url = GetUrlSepasNode() + "/SOAPService.asmx";
                ...
                result = srv.SaveSOAPReportSecure(b);
                return result;
            }
            catch (Exception ex)
            {
        ...
        public ResultVO SaveAdmittedMessage(AdmittedMessageVO AdmittedMessage)
        {
            try
            {
                DO_IDENTIFIER Location = GetHealthCareFacility();
                ClientWebService.SepasGate.MergAdaptorService srv = new ClientWebService.SepasGate.MergAdaptorService();
                srv.Url = GetUrlSepasNode() + "/AdmittedService.asmx";
                ...
                result = srv.SaveAdmittedMessageSecure(b);
                return result;
            }
            catch (Exception ex)
            {
        ...
        public ResultVO SendInsurerReimbursement(InsurerReimbursementMessageVO InsurerReimbursementMessage)
        {
            try
            {
                ...
                ClientWebService.SepasGate.MergAdaptorService srv = new ClientWebService.SepasGate.MergAdaptorService();
                srv.Url = GetUrlSepasNode() + "/InsurerReimbursementService.asmx";
                ...
                // -------------------------------------Send Message to SEPAS if needed--------------------------------
                return srv.SaveInsurerReimbursementSecure(b);
            }
            // -------------------------------------Send Message to SEPAS if needed--------------------------------
            catch (Exception ex)
            {
        ...
        public ResultVO SavePatientBill(PatientBillMessageVO PatientBillMessage)
        {
            try
            {
                DO_IDENTIFIER Location = GetHealthCareFacility();
                ClientWebService.SepasGate.MergAdaptorService srv = new ClientWebService.SepasGate.MergAdaptorService();
                srv.Url = GetUrlSepasNode() + "/BillPatientService.asmx";
                ...
                result = srv.SavePatientBillSecure(b);
                return result;
            }
            catch (Exception ex)
            {
        ...
        public DO_IDENTIFIER ConvertOrganizationID(DO_IDENTIFIER OrganizationID, string DestinationIssuer)
        {
            string MethodName = "ConvertOrganizationID";
            try
            {
                // ------------------------part1------------------------------------------
                SDK.AdditionalTools.Basic.Chronometer TimeTotal = new SDK.AdditionalTools.Basic.Chronometer();
                ...
                // ------------------------part2------------------------------------------
                SDK.AdditionalTools.Basic.Chronometer Time = new SDK.AdditionalTools.Basic.Chronometer();
                r = Srv.ConvertOrganizationID_T2(OrganizationID, DestinationIssuer); // ---------------------------Service Call
                _WL("...Call Service Time [" + MethodName + "]", Time);
                object result = _ReturnGeneralResponseMessage(r, KP);
                _WL("CallHIX Total Time", TimeTotal);
                return result;
        ...
        public string LogActivity(string Activity)
        {
            ...
            try
            {
                ...
                // ------------------------part2------------------------------------------
                SDK.AdditionalTools.Basic.Chronometer Time = new SDK.AdditionalTools.Basic.Chronometer();
                r = Srv.LogActivity(Activity); // ---------------------------Service Call
                _WL("...Call Service Time [" + MethodName + "]", Time);
                object result = _ReturnGeneralResponseMessage(r, KP);
                _WL("CallHIX Total Time", TimeTotal);
                return result;
        ...
        public Service()
        {
            try
            {
                ...
                TimeSpan diff = dnow.Subtract(SDK.Configuration.CertificationExpirationDate);
                if (SDK.Configuration.Certification_Is_Unlimited == false)
                {
                    if (diff.TotalDays > 0)
