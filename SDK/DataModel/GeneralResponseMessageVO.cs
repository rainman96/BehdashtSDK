...
// Type: SDK.DataModel.GeneralResponseMessageVO
...
namespace SDK.DataModel
{
    ...
    [Serializable]
    public class GeneralResponseMessageVO
    {
        [XmlElement(DataType = "base64Binary")]
        public byte[] ObjectByte { get; set; }

        public int ObjectSerializedAlgorithm { get; set; }
